...
const CONFIG = {
  ...
  saturdayMorningDates: ['2026-05-30', '2026-06-13', '2026-06-20', '2026-07-11', '2026-07-18', '2026-08-01', '2026-08-15', '2026-08-29', '2026-09-12', '2026-09-26', '2026-10-10', '2026-10-24'],

  // ★ 休診／請假（整天不開診）：YYYY-MM-DD
  daysOff: ['2026-07-04', '2026-07-11', '2026-07-25', '2026-07-26', '2026-07-27'],

  // ★ 半天停診（只停某幾個診次，整天停診請用 daysOff）：'YYYY-MM-DD': ['早'|'午'|'夜', ...]
  //   一處生效兩站：schedule-core.clinicForDate 會濾掉該診次的所有時段（預約頁/後台/Yanice），
  //   門診表.html 月曆該診次改標「停診」、總覽 foot 自動列出（過期日期自動消失）。
  sessionsOff: {
    '2026-09-12': ['午', '夜'],
    '2026-09-13': ['早'],
  },
  ...
  bookings: [
    ...
    { date:'2026-09-20', slot:'15:00', who:'XMR' },   // 時間未定，暫填 15:00
  ...
  extraSlots: [
    ...
    { date:'2026-09-20', slot:'15:00', label:'15:00', copy:'下午 15:00' },
  ],
